...
```{r}
fert_df <- fert %>% select(country, start_yr, end_yr, hhid, plotid, area, fert_yn, npk_yn, urea_yn, comp_manure_yn, other_yn, npk_quant, urea_quant, comp_manure_quant, other_quant, total_quant, longitude, latitude)
fert_df
```
